...
const SubBanner = () => {
  return (
    <div className="sm:container mx-5 sm:mx-auto bg-[#4361EE] p-10 flex flex-col items-center my-24 rounded-2xl">
      <h2 className="text-3xl font-bold text-white my-3 text-center">
        Sign up today for a risk-free, 30-day trial for up to 4 learners.
      </h2>
      ...
      <Link className="btn md:w-1/3 p-7 text-blue-700 text-xl" to={"/all-skills"}>
        <button >
          Go to All Skills for start 30-day free trial
        </button>
      </Link>
    </div>
  );
